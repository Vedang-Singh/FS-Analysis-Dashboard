<table border="0">
  <tr>
    <td width="120" valign="center">
      <img src="./Images/PowerBI_logo.png" width="100" height="100">
    </td>
    <td valign="top">
      <h1>Financial Statement Analysis Dashboard</h1>
      <p>A dynamic Power BI project transforming raw Balance Sheet and Profit & Loss Statement data into a strategic decision-making tool.</p>
    </td>
  </tr>
</table>
